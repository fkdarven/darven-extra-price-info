	...
	if (!class_exists('Darven_Epi_General_Settings_Fields')) {
		class Darven_Epi_General_Settings_Fields
		{
			...
			public function darven_epi_general_settings(): void
			{
				...
				$this->register_settings_field('darven_epi_mode_of_view', 'Mode of View', 'darven_epi_installments_settings_section');
			...
			public function darven_epi_type_of_discount_callback(): void
			{
                ...
                <option value="percent" <?php echo $selected; ?>> <?php echo esc_attr(__('Percent', DARVEN_EPI_LANGUAGE_DOMAIN)) ?></option>
                ...
                <option value="fixed" <?php echo $selected; ?>>  <?php echo esc_attr(__('Fixed'), DARVEN_EPI_LANGUAGE_DOMAIN) ?></option>
            </select> <?php
			}
